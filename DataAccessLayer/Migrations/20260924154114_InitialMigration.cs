        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Qualities = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Encumbrance = table.Column<int>(type: "int", nullable: false),
                    TechLevel = table.Column<int>(type: "int", nullable: false),
                    SlotsTaken = table.Column<int>(type: "int", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Resources = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CultProtection", x => new { x.CultsId, x.ProtectionId });
                    table.ForeignKey(
                        name: "FK_CultProtection_Cults_CultsId",
                        column: x => x.CultsId,
                        principalTable: "Cults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CultProtection_Protections_ProtectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterBurns", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyFlesh = table.Column<int>(type: "int", nullable: false),
                    StructureTrauma = table.Column<int>(type: "int", nullable: false),
                    BodyFleshLost = table.Column<int>(type: "int", nullable: false),
                    StructureTraumaLost = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterBurns_CharacterId",
                table: "CharacterBurns",
                column: "CharacterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CultProtection_ProtectionId",
                table: "CultProtection",
                column: "ProtectionId");
